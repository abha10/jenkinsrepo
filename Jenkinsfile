node {
       ...
       stage('Deploy') {
           ...
           echo "${params.Request-Item-ID}";

           //def response = httpRequest consoleLogResponseBody: true, contentType: 'APPLICATION_JSON', httpMode: 'POST', ignoreSslErrors: true, requestBody:'''+"${params.Request-Item-ID}"+''', url: 'https://dev39754.service-now.com/api/190726/snow_jenkins'  
